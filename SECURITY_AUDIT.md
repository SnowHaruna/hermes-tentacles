```json
{
  ...
  "result": "V6.2安全加固验证完成。V6.1审计发现的10项漏洞中9项已代码修复(M2/C3/H1/H2/M1/M2/M3/L1/L2)，仅C1(GitHub PAT明文在.git/config)需军哥手动轮换。增量审计发现4项新问题(N1~N4)，均为LOW/INFO级别，无新增CRITICAL/HIGH/MEDIUM。总体安全评级: 🟢 良好(较V6.1的🟡显著提升)。唯一阻塞项: C1 PAT轮换(P0)。",
  "time_seconds": 310.4,
  "runs": 1,
  ...
  "report_summary": {
    ...
    "fix_verification": {
      ...
      "C1_pat_leak": "⚠️ 待军哥手动: 登录GitHub轮换ghp_0A...6SK6+用credential helper"
    },
    "new_vulnerabilities": {
    ...
    "action_items": [
      "P0: 军哥轮换GitHub PAT → GitHub Settings → Developer settings → Personal access tokens",
